            ...
            <form className="contains-SignUp">
                ...
                <div className='contains-inputs'>
                    <div className={errorFields?.includes('username') ? 'oSaAibaEroare flex w-full flex-wrap md:flex-nowrap md:mb-0 gap-4' : 
                        ...
                        <Input required type="email" variant="bordered"
                    ...
                    <div className="loginIcons">
                        <svg className="github_icon" fill = "white" xmlns="http://www.w3.org/2000/svg" cursor = "pointer" x="0px" y="0px" width="55" height="55" viewBox="0 0 30 30">
